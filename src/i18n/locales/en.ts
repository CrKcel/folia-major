...
export default {
  ...
  "options": {
    ...
    "customShortcutDesc": "Alt plus a letter, running one command outright. Only letters nothing else has claimed are listed, and only commands that work on any surface.",
