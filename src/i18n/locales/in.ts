...
export default {
  ...
  "options": {
    ...
    "customShortcutDesc": "Alt ditambah satu huruf, langsung menjalankan satu perintah. Hanya huruf yang belum dipakai dan perintah yang berlaku di semua tampilan yang ditawarkan.",
